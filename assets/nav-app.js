...
function renderRisingSpotlight(){
  ...
  box.innerHTML=`<div class="rising-head"><div><span class="eyebrow">GitHub Rising</span><h2>${t('risingTitle')}</h2><p>${t('risingSubtitle')}</p></div><a href="/trending/">${t('risingMore')} →</a></div><div class="rising-grid">${cards}</div>`;
}
